...
wrapper "Install common packages" sudo pacman -S --noconfirm --needed fastfetch onefetch tokei htop git nano man-db exa wget bc unzip gdu speedtest-cli ripgrep github-cli tldr man-pages man-db
...
# Configure bluetooth
wrapper "Install audio and bluetooth specific packages" sudo pacman -S --noconfirm bluez bluez-utils pipewire pipewire-pulse pipewire-alsa wireplumber
